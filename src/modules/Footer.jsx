        ...
        <div className="container footer__container">
            ...
            <div className="footer-info">
                ...
                <ul className="footer__developers">
                    <li className="footer__description">Проект сделан в учебных целях</li>
                    <li className="footer-developer">Designer:
                        <a href="#" className="footer__developer-link">Anastasia Ilina</a>
                    </li>
                    <li className="footer-developer">Developer:
                        <a href="#" className="footer__developer-link">Bulycheva Ekaterina</a>
                    </li>
                </ul>
            </div>
